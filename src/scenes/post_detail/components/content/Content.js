  ...
  return (
    <section className="content-board">
      <article className="content-board__content">
        <h2 className="content-board__title">{samplePost.title}</h2>
        <div className="content-board__info-wrapper">
          <span className="content-board__date">{samplePost.date}</span>
          <div>
            <span className="content-board__category">
              {samplePost.category}
            </span>
            <span> | </span>
            <span className="content-board__writer">{samplePost.writer}</span>
          </div>
        </div>
        <div className="content-board__detail">{samplePost.detail}</div>
